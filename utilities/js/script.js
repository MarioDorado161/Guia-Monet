...
Karmeleon.Behavior.ExpandNewNavbar = function (e) {
  ...
  // Aquí añades el cierre al clicar en opciones del menú lateral
  r.find(".k-new-navbar-side-bar-item").on("click", function () {
    if (a()) {
      u();
      $(this).blur();          // quitar foco para evitar cambio de estilo
      $(this).css("font-weight", "400"); // opcional, forzar font-weight
    }
  });
